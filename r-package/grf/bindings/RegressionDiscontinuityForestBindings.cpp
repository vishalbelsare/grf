...
// [[Rcpp::export]]
Rcpp::List rdd_train(Rcpp::NumericMatrix train_matrix,
                     Eigen::SparseMatrix<double> sparse_train_matrix,
                     size_t outcome_index,
                     size_t treatment_index,
                     size_t running_variable_index,
                     ...
                     unsigned int seed) {
  ForestTrainer trainer = regression_discontinuity_trainer(reduced_form_weight, stabilize_splits);
  ...
  data->set_instrument_index(running_variable - 1);
  ...
  if (compute_oob_predictions) {
    ForestPredictor predictor = rdd_predictor(num_threads);
...
// [[Rcpp::export]]
Rcpp::List rdd_predict(Rcpp::List forest_object,
  ...
  ForestPredictor predictor = regression_discontinuity_predictor(num_threads);
...
// [[Rcpp::export]]
Rcpp::List rdd_predict_oob(Rcpp::List forest_object,
                           Rcpp::NumericMatrix train_matrix,
                           Eigen::SparseMatrix<double> sparse_train_matrix,
                           size_t outcome_index,
                           size_t treatment_index,
