...
#ifndef GRF_REGRESSIONDISCONTINUITYPREDICTIONSTRATEGY_H
#define GRF_REGRESSIONDISCONTINUITYPREDICTIONSTRATEGY_H
...
class RegressionDiscontinuityPredictionStrategy final: public OptimizedPredictionStrategy {
public:
...
#endif //GRF_REGRESSIONDISCONTINUITYPREDICTIONSTRATEGY_H
