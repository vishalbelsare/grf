...
const std::size_t RegressionDiscontinuityPredictionStrategy::OUTCOME = 0;
const std::size_t RegressionDiscontinuityPredictionStrategy::TREATMENT = 1;
const std::size_t RegressionDiscontinuityPredictionStrategy::INSTRUMENT = 2;
const std::size_t RegressionDiscontinuityPredictionStrategy::OUTCOME_INSTRUMENT = 3;
const std::size_t RegressionDiscontinuityPredictionStrategy::TREATMENT_INSTRUMENT = 4;
const std::size_t RegressionDiscontinuityPredictionStrategy::INSTRUMENT_INSTRUMENT = 5;

const std::size_t NUM_TYPES = 6;

size_t RegressionDiscontinuityPredictionStrategy::prediction_length() const {
    return 1;
}

std::vector<double> RegressionDiscontinuityPredictionStrategy::predict(const std::vector<double>& average) const {
...
std::vector<double> RegressionDiscontinuityPredictionStrategy::compute_variance(
...
size_t RegressionDiscontinuityPredictionStrategy::prediction_value_length() const {
  return NUM_TYPES;
}

PredictionValues RegressionDiscontinuityPredictionStrategy::precompute_prediction_values(
...
std::vector<std::pair<double, double>> RegressionDiscontinuityPredictionStrategy::compute_error(
    size_t sample,
    const std::vector<double>& average,
    const PredictionValues& leaf_values,
    const Data& data) const {
